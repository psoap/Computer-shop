...
public final class ValidatorSettingsStorage {
    ...
    public static final Pattern DELIVERY_PROFILE_FULL_NAME_PATTERN = Pattern.compile("^[\\p{Alnum}\\p{IsCyrillic}]{1,32}");
    public static final Pattern DELIVERY_PROFILE_ADDRESS_PATTERN = Pattern.compile("^[\\s\\w\\p{IsCyrillic},./-]{1,255}");
    public static final Pattern DELIVERY_PROFILE_PHONE_PATTERN = Pattern.compile("^[+][0-9]{6,12}");
